...
class GetFriendResponse final :
 ...
 public:
  ...
  explicit PROTOBUF_CONSTEXPR GetFriendResponse(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  void MergeFrom( const GetFriendResponse& from) {
    GetFriendResponse::MergeImpl(*this, from);
  }
  private:
  static void MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg);
  public:
...
inline const ::fixbug::ResultCode& GetFriendResponse::result() const {
...
inline ::fixbug::ResultCode* GetFriendResponse::release_result() {
...
inline ::fixbug::ResultCode* GetFriendResponse::unsafe_arena_release_result() {
...
inline ::fixbug::ResultCode* GetFriendResponse::_internal_mutable_result() {
...
inline ::fixbug::ResultCode* GetFriendResponse::mutable_result() {
  ::fixbug::ResultCode* _msg = _internal_mutable_result();
  // @@protoc_insertion_point(field_mutable:fixbug.GetFriendResponse.result)
  return _msg;
}
inline void GetFriendResponse::set_allocated_result(::fixbug::ResultCode* result) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArenaForAllocation();
  if (message_arena == nullptr) {
    delete _impl_.result_;
  }
...
// repeated .fixbug.User friend_list = 2;
inline int GetFriendResponse::_internal_friend_list_size() const {
  return _impl_.friend_list_.size();
}
inline int GetFriendResponse::friend_list_size() const {
  return _internal_friend_list_size();
}
inline void GetFriendResponse::clear_friend_list() {
  _impl_.friend_list_.Clear();
}
inline ::fixbug::User* GetFriendResponse::mutable_friend_list(int index) {
  // @@protoc_insertion_point(field_mutable:fixbug.GetFriendResponse.friend_list)
  return _impl_.friend_list_.Mutable(index);
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::fixbug::User >*
GetFriendResponse::mutable_friend_list() {
  // @@protoc_insertion_point(field_mutable_list:fixbug.GetFriendResponse.friend_list)
  return &_impl_.friend_list_;
}
inline const ::fixbug::User& GetFriendResponse::_internal_friend_list(int index) const {
  return _impl_.friend_list_.Get(index);
}
inline const ::fixbug::User& GetFriendResponse::friend_list(int index) const {
  // @@protoc_insertion_point(field_get:fixbug.GetFriendResponse.friend_list)
  return _internal_friend_list(index);
}
inline ::fixbug::User* GetFriendResponse::_internal_add_friend_list() {
  return _impl_.friend_list_.Add();
}
inline ::fixbug::User* GetFriendResponse::add_friend_list() {
  ::fixbug::User* _add = _internal_add_friend_list();
  // @@protoc_insertion_point(field_add:fixbug.GetFriendResponse.friend_list)
  return _add;
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::fixbug::User >&
GetFriendResponse::friend_list() const {
  // @@protoc_insertion_point(field_list:fixbug.GetFriendResponse.friend_list)
  return _impl_.friend_list_;
}
