...
const uint32_t TableStruct_test_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::fixbug::GetFriendResponse, _impl_.friend_list_),
};
static const ::_pbi::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  { 40, -1, -1, sizeof(::fixbug::GetFriendResponse)},
};
...
const ::_pbi::DescriptorTable descriptor_table_test_2eproto = {
    false, false, 418, descriptor_table_protodef_test_2eproto,
    "test.proto",
...
class GetFriendResponse::_Internal {
 public:
  static const ::fixbug::ResultCode& result(const GetFriendResponse* msg);
};
...
template<> PROTOBUF_NOINLINE ::fixbug::GetFriendResponse*
Arena::CreateMaybeMessage< ::fixbug::GetFriendResponse >(Arena* arena) {
